...
import Service1 from "../assets/components/service1";
import HomePageStep from "../assets/components/homePageStep";
    ...
    <div className="md:!pt-15 sm:!pt-10">
      ...
      <div className="!mt-20 !mb-1">
        ...
        <div className="lg:!mb-30 md:!mb-40 !mb-25">
          <div
            div
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 !gap-30 !px-6 lg:!px-15 justify-center place-self-center"
          >
            {things.map((thing) => (
